    ...
    return createPortal(
        ...
        >
            <div
                ...
                className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white text-black dark:text-white dark:bg-[#101828]  rounded-xl shadow-lg  overflow-hidden max-w-[90%]"
            >
                {children}
